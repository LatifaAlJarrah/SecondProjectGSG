...
export default function Footer() {
    ...
    return (
        <footer className="relative mt-16 bg-black text-white">
            <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-4 py-12 sm:grid-cols-2 md:grid-cols-7">
                <div className="space-y-6 col-span-2">
                    <Logo className="text-2xl font-bold text-white" />
                    <p className="text-xl font-medium mt-4">Subscribe</p>
                    <p className="text-sm font-normal">Get 10% off your first order</p>
                    <form
                        onSubmit={(e) => e.preventDefault()}
                        className="flex items-center overflow-hidden rounded-sm border border-white"
                    >
                        <input
                            type="email"
                            placeholder="Enter your email"
                            className="w-full bg-transparent px-3 py-2 text-xs outline-none placeholder:text-neutral-500"
                        />
                        <button className="grid h-9 w-9 place-items-center center pr-2" aria-label="Subscribe">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9.91199 11.9998H3.99999L2.02299 4.1348C2.01033 4.0891 2.00262 4.04216 1.99999 3.9948C1.97799 3.2738 2.77199 2.7738 3.45999 3.1038L22 11.9998L3.45999 20.8958C2.77999 21.2228 1.99599 20.7368 1.99999 20.0288C2.00201 19.9655 2.01313 19.9029 2.03299 19.8428L3.49999 14.9998" stroke="#FAFAFA" strokeWidth="1.5" strokeLinejoin="round" />
                            </svg>
                ...
                <div className="space-y-3 text-sm">
                    <h5 className="mb-4 font-medium text-xl">Support</h5>
                    <p className="text-neutral-400">111 Bijoy sarani, Dhaka, DH 1515, Bangladesh.</p>
                    <Link href="mailto:exclusive@gmail.com" className="block text-neutral-300 hover:text-white">
                        exclusive@gmail.com
                    </Link>
                    <Link href="tel:+8801588888999" className="block text-neutral-300 hover:text-white">
                        +88015-88888-9999
                    </Link>
                </div>

                <div className="space-y-2 text-sm">
                    <h5 className="mb-4 font-medium text-xl">Account</h5>
                ...
                <div className="space-y-2 text-sm">
                    <h5 className="mb-4 font-medium text-xl">Quick Link</h5>
                ...
                <div className="space-y-3 text-sm col-span-2">
                    <h5 className="mb-4 font-medium text-xl">Download App</h5>
                    <p className="text-xs text-neutral-400">Save $3 with App New User Only</p>
                    <div className="flex items-center gap-3 h-20">
                        {/* QR code box */}
                        <div className="grid h-20 w-20 place-items-center rounded-sm bg-white p-1">
                            <Image
            ...
            <button
                ...
                className={`fixed bottom-6 right-6 grid h-12 w-12 place-items-center rounded-full bg-[#F5F5F5] text-white shadow transition ${showTop ? "opacity-100" : "opacity-0 pointer-events-none"
                    }`}
            >
                <ArrowUpIcon />
            </button>
...
function FooterLink({ href, children }: { href: string; children: React.ReactNode }) {
    return (
        <Link href={href} className="block text-neutral-300 hover:text-white">
            {children}
        </Link>
    );
}
...
function TwitterIcon() {
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_6599_1563)">
